...
import { Alert, Text, View, AppState, ScrollView } from "react-native";
    ...
    <View className="relative flex-col items-center justify-center flex-1 w-full gap-y-20">
      ...
      <View className="flex flex-col w-96 gap-y-4">
        ...
        <View className="flex flex-row justify-start">
          {isSignIn ? (
            <Text onPress={() => setIsSignIn(false)} className="cursor-pointer">
      ...
      >
        <ScrollView className="flex flex-col px-10 py-10 bg-white gap-y-4">
          ...
          <Text>
            ...
            publie et doit respecter les lois en vigueur. Les défis ne sont pas
            modérés par Derkap avant leur publication. Les utilisateurs
            ...
            photos sont chiffrées pour garantir la vie privée des utilisateurs.
            Derkap ne vend ni ne partage les données des utilisateurs avec des
            tiers. L'utilisateur peut demander la suppression de son compte et
            de ses données en envoyant un email à contact.derkap@gmail.com.
            Derkap ne peut être tenu responsable en cas de piratage ou de fuite
            de données. {"\n"} {"\n"}
            5. Monétisation {"\n"}
            ...
            utilisateurs. L'application est fournie "en l'état" sans garantie de
            fonctionnement continu. Les utilisateurs sont responsables de leur
            propre utilisation et des conséquences de leurs publications. {
              "\n"
            }{" "}
            {"\n"}
            ...
            En utilisant Derkap, vous reconnaissez avoir lu et accepté ces CGU.
            En cas de non-respect, votre accès à l'application pourra être
            restreint ou supprimé. {"\n"}
