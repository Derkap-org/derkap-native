...
CREATE TYPE "public"."friendship_status_type" AS ENUM (
    'friend',
...
ALTER TYPE "public"."friendship_status_type" OWNER TO "postgres";


CREATE TYPE "public"."suggested_challenge_category" AS ENUM (
    'perspective',
    'selfie avec',
    'lieu insolite',
    'absurde',
...
ALTER TYPE "public"."suggested_challenge_category" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."search_users_friendship_status"("p_search_username" "text", "p_current_user_id" "uuid") RETURNS TABLE("id" "uuid", "username" "text", "avatar_url" "text", "email" "text", "friendship_status" "public"."friendship_status_type", "friend_request_id" "uuid")
    LANGUAGE "plpgsql"
    AS $$
begin
  return query
...
ALTER FUNCTION "public"."search_users_friendship_status"("p_search_username" "text", "p_current_user_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."delete_account" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "profile_id" "uuid"
);
...
ALTER TABLE "public"."delete_account" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."friends_request" (
    ...
    CONSTRAINT "valid_status" CHECK (("status" = ANY (ARRAY['pending'::"public"."friend_request_status", 'accepted'::"public"."friend_request_status", 'rejected'::"public"."friend_request_status"])))
);


ALTER TABLE "public"."friends_request" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."friends" AS
 SELECT "fr"."created_at",
    ...
    "p"."avatar_url",
    "p"."username"
   FROM ("public"."friends_request" "fr"
     JOIN "public"."profile" "p" ON (("p"."id" =
        CASE
            WHEN ("fr"."sender_id" = "auth"."uid"()) THEN "fr"."receiver_id"
            ELSE "fr"."sender_id"
        END)))
  WHERE (("fr"."status" = 'accepted'::"public"."friend_request_status") AND (("fr"."sender_id" = "auth"."uid"()) OR ("fr"."receiver_id" = "auth"."uid"())));
...
CREATE TABLE IF NOT EXISTS "public"."suggested_challenge" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "challenge" "text" NOT NULL,
    "category" "public"."suggested_challenge_category" NOT NULL
);


ALTER TABLE "public"."suggested_challenge" OWNER TO "postgres";


ALTER TABLE "public"."suggested_challenge" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."suggested_challenge_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."suggested_challenge"
    ADD CONSTRAINT "suggested_challenge_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."friends_request"
    ADD CONSTRAINT "friends_request_receiver_id_fkey" FOREIGN KEY ("receiver_id") REFERENCES "public"."profile"("id");



ALTER TABLE ONLY "public"."friends_request"
    ADD CONSTRAINT "friends_request_sender_id_fkey" FOREIGN KEY ("sender_id") REFERENCES "public"."profile"("id");
...
CREATE POLICY "All" ON "public"."delete_account" USING (true);
...
CREATE POLICY "Receivers can delete request" ON "public"."friends_request" FOR DELETE USING (("receiver_id" = "auth"."uid"()));



CREATE POLICY "Senders can delete request" ON "public"."friends_request" FOR DELETE USING (("sender_id" = "auth"."uid"()));
...
CREATE POLICY "Users can create friend requests" ON "public"."friends_request" FOR INSERT TO "authenticated" WITH CHECK (("sender_id" = "auth"."uid"()));
...
CREATE POLICY "Users can update friend requests they received" ON "public"."friends_request" FOR UPDATE TO "authenticated" USING (("receiver_id" = "auth"."uid"()));
...
CREATE POLICY "Users can view their own friend requests" ON "public"."friends_request" FOR SELECT TO "authenticated" USING ((("sender_id" = "auth"."uid"()) OR ("receiver_id" = "auth"."uid"())));
...
ALTER TABLE "public"."suggested_challenge" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."search_users_friendship_status"("p_search_username" "text", "p_current_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."search_users_friendship_status"("p_search_username" "text", "p_current_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_users_friendship_status"("p_search_username" "text", "p_current_user_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."delete_account" TO "anon";
GRANT ALL ON TABLE "public"."delete_account" TO "authenticated";
GRANT ALL ON TABLE "public"."delete_account" TO "service_role";
...
GRANT ALL ON TABLE "public"."friends_request" TO "anon";
GRANT ALL ON TABLE "public"."friends_request" TO "authenticated";
GRANT ALL ON TABLE "public"."friends_request" TO "service_role";
...
GRANT ALL ON TABLE "public"."suggested_challenge" TO "anon";
GRANT ALL ON TABLE "public"."suggested_challenge" TO "authenticated";
GRANT ALL ON TABLE "public"."suggested_challenge" TO "service_role";



GRANT ALL ON SEQUENCE "public"."suggested_challenge_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."suggested_challenge_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."suggested_challenge_id_seq" TO "service_role";
