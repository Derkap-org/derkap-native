...
CREATE POLICY "Enable update for users based on created_id" ON "public"."challenge" FOR UPDATE USING ((( SELECT "auth"."uid"() AS "uid") = "creator_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "creator_id"));
