...
export const getEncryptionKey = async ({
  ...
  const key = `encryption_key_${group_id}_${challenge_id}`;
...
export const generateChallengeBaseKey = async ({ text }: { text: string }) => {
  const challenge_key = await Crypto.digestStringAsync(
