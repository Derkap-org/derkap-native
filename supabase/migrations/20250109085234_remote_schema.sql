...
CREATE OR REPLACE TRIGGER "auto_update_challenge_status_to_voting" AFTER INSERT ON "public"."encrypted_post" FOR EACH ROW EXECUTE FUNCTION "public"."update_challenge_status_to_voting"();
