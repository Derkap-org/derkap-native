...
CREATE TABLE IF NOT EXISTS "public"."new-table" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
);


ALTER TABLE "public"."new-table" OWNER TO "postgres";


ALTER TABLE "public"."new-table" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."new-table_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."new-table"
    ADD CONSTRAINT "new-table_pkey" PRIMARY KEY ("id");
...
ALTER TABLE "public"."new-table" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."new-table" TO "anon";
GRANT ALL ON TABLE "public"."new-table" TO "authenticated";
GRANT ALL ON TABLE "public"."new-table" TO "service_role";



GRANT ALL ON SEQUENCE "public"."new-table_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."new-table_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."new-table_id_seq" TO "service_role";
